...
#ifndef MAIN_LIB_ADXL345_ADXL345_HPP_
#define MAIN_LIB_ADXL345_ADXL345_HPP_
...
class ADXL345
{
  ...
  protected:
	 ...
	 esp_err_t setRegisterBit(uint8_t regAdress, int bitPos, bool state);
...
#endif /* MAIN_LIB_ADXL345_ADXL345_HPP_ */
